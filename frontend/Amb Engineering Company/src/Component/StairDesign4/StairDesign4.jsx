  ...
  return (
    ...
    <div  className={`bg-gradient-to-r from-gray-200 to-blue-100   md:mt-5 mt-3  py-13`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <img
            ...
            src={stair4[design_no].img}
            alt="Laser Cut Gate Design"
          />
        </div>

        <Whatsapp_Button message="I visited from your Stair Railing Design Page!" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col justify-center ">
            ...
            >
              ...
              {stair4[design_no].title.split(" ").slice(0, -1).join(" ")}{" "}
              {parseInt(stair4[design_no].title.split(" ").pop()) + 1}
            </motion.h1>
            <motion.p
      ...
      <div className="mt-10 max-w-7xl mx-auto  ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 ">
          {firstfourrelateditem.map((item, index) => (
            <NavLink
              ...
              to={`/Stair-Laser-Cut-Design-4/stair-design-${item.pathn
                .split("-")
                .pop()}`}
            >
              <div
        ...
        <NavLink to={"/StairRailingOurServices"}>
