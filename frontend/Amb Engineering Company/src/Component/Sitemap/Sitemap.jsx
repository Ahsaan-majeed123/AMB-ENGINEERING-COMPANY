  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="mt-8 text-center">
        <p className="text-gray-600">Need help? Please <a href="mailto:farhanbajwa418@gmail.com?subject=From%20Amb%20Engineering&body=Assalam%20u%20alaikum" className="text-blue-500">contact us</a>.</p>
      </div>
    </div>
  );
};
