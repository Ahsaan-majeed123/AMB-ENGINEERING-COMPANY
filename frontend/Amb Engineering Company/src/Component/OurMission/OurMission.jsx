...
const OurMission = () => {
  ...
  return (
    <div className="bg-blue-50 py-16">
      <div className=" flex flex-col md:flex-row gap-8 max-w-7xl mx-auto px-4 border-t-4 pt-5 border-b-4 border-gray-300 rounded-lg shadow-xl">
        {/* Image Section */}
        <div className="relative  w-full sm:w-[50%] md:w-[38%] mx-auto overflow-hidden rounded-lg shadow-lg  h-max">
          <img
            ...
            className="border border-6 border-amber-600 w-[79vw] sm:w-full sm:h-[80vh] mx-auto h-[60vh] rounded-lg shadow-xl"
          />
...
<div className="absolute bottom-0 left-1/2  transform translate-x-1       border-4 border-white  rounded-sm   shadow-lg ">
              <img
        ...
        <div className="w-full pt-3 md:w-[60%] flex flex-col justify-center text-center md:text-left space-y-6">
          ...
          <div className="mt-12 mb-12  overflow-hidden">
            ...
            <div className="text-xl text-gray-600 leading-relaxed mb-4 flex gap-3">
              ...
              >
               <div><strong>Our goal</strong> is to harness cutting-edge <em>technology</em> and creativity to offer top-tier <strong>laser cutting services</strong>. We are dedicated to delivering precise, <b>accurate</b>, and <u>on-time</u> solutions to our clients.</div>
            ...
            <div className=" text-xl text-gray-600 leading-relaxed mb-4 flex gap-3">
              ...
              <motion.div
                ...
                className="w-[90%] text-justify"
              >
                <div>We <strong>strive</strong> to turn our clients' <u>visions</u> into reality by utilizing <em>state-of-the-art equipment</em> and <b>innovative processes</b>.</div>
            ...
            <div className="flex text-xl text-gray-600 leading-relaxed mb-4 gap-3">
              ...
              <motion.div
                ...
                className="w-[90%] text-justify"
              >
              <div>Our <strong>goal</strong> is to establish ourselves as a trusted leader in the <em>laser cutting industry</em>, known for our <b>high-quality solutions</b> and <b>dependable services</b>. We aim to consistently deliver <i>innovative</i> and <b>precise</b> cutting-edge solutions to our clients.</div>
            ...
            ><strong>AMB Engineering Company</strong> laser cutters are essential tools for both prototyping and large-scale manufacturing. Our <em>advanced laser cutting technology</em> is widely used in <b>machine shops</b> to efficiently cut large materials. <b>AMB Engineering Company</b> is trusted by hardware firms to create affordable, high-speed prototypes.</motion.div>
